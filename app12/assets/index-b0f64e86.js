...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: emit2 }) {
    const search = ref("");
    function navEmit() {
      console.log("nav2 emit");
      emit2("search", search.value);
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(RouterLink), {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Suspense, null, {
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(list), (file) => {
            return openBlock(), createElementBlock("div", _hoisted_1$1, [
              createBaseVNode("div", null, toDisplayString(file.title), 1)
            ]);
          }), 256))
        ]),
        _: 1
...
const List = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ea5bfd22"]]);
const Items_vue_vue_type_style_index_0_lang = "";
const _hoisted_1 = { id: "list" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function search(arg) {
      ...
      cat.value = false;
      fish.value = false;
      if (arg === "bird" || arg === "Bird") {
        bird.value = true;
      } else if (arg === "dog" || arg === "Dog") {
        dog.value = true;
      } else if (arg === "cat" || arg === "Cat") {
        cat.value = true;
      } else if (arg === "fish" || arg === "Fish") {
        fish.value = true;
      }
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_sfc_main$2, { onSearch: search }),
        createBaseVNode("main", null, [
          createBaseVNode("div", _hoisted_1, [
            createVNode(List)
          ]),
          bird.value ? (openBlock(), createElementBlock("div", _hoisted_2, _hoisted_4)) : createCommentVNode("", true),
          dog.value ? (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_7)) : createCommentVNode("", true),
          cat.value ? (openBlock(), createElementBlock("div", _hoisted_8, _hoisted_10)) : createCommentVNode("", true),
          fish.value ? (openBlock(), createElementBlock("div", _hoisted_11, _hoisted_13)) : createCommentVNode("", true)
        ])
      ], 64);
    };
  }
