...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    let streetAddress = store.streetAddress;
    let city = store.city;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("main", null, [
        createVNode(_component_RouterLink, { to: "/edit" }, {
          default: withCtx(() => [
            createTextVNode("Edit")
          ]),
          _: 1
        }),
        createBaseVNode("div", null, toDisplayString(unref(firstName)) + " " + toDisplayString(unref(lastName)), 1),
        createBaseVNode("div", null, toDisplayString(unref(streetAddress)), 1),
        createBaseVNode("div", null, toDisplayString(unref(city)) + ", " + toDisplayString(unref(state)) + ", " + toDisplayString(unref(zipcode)), 1)
      ]);
    };
  }
};
const EditView_vue_vue_type_style_index_0_lang = "";
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("label", { for: "firstName" }, "First Name: ", -1);
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("label", { for: "lastName" }, "Last Name: ", -1);
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("label", { for: "streetAddress" }, "Street Address: ", -1);
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("label", { for: "city" }, "City: ", -1);
...
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("label", { for: "zipcode" }, "Zip code: ", -1);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function submit() {
      ...
      store.streetAddress = streetAddress.value;
      store.city = city.value;
      store.state = state.value;
      store.zipcode = state.zipcode;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        ...
        _hoisted_5,
        withDirectives(createBaseVNode("input", {
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => streetAddress.value = $event),
          name: "streetAddress",
          type: "text"
        }, null, 512), [
          [vModelText, streetAddress.value]
        ]),
        _hoisted_6,
        _hoisted_7,
        withDirectives(createBaseVNode("input", {
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => __vitePreload(() => import("./AboutView-87274f3d.js"), true ? ["assets/AboutView-87274f3d.js","assets/AboutView-fe0787ef.css"] : void 0)
    }
  ]
});
const main = "";
