...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    let createS = function() {
      ...
      let light = new B.HemisphericLight("light0", new B.Vector3(1, 2, 3), s);
      light.intensity = 0.9;
      let middleS = B.Mesh.CreateSphere("sp2", 18, 8);
      let sMaterial = new B.StandardMaterial("texture", s);
      sMaterial.diffuseColor = new B.Color3(0.31, 0.14, 0.07);
      middleS.material = sMaterial;
      console.log("test");
      return s;
    };
    let scene = createS();
